...
6. Bạn có thể thử nghiệm với các dữ liệu mẫu về bài hát, album, nghệ sĩ, v.v. được lưu trữ trong file data.js để xem cách web hoạt động với các dữ liệu khác nhau
<br>
...
<br>
<br>
~~mất ngủ vì làm bài tập nhóm, không thích bài tập nhóm /ᐠ ╥ ˕ ╥マ | (ง ͠ಥ_ಥ)ง | (◞‸ ◟)💧~~
